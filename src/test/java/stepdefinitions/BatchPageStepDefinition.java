...
batchPage.batchheadercolumn(batch);
	...
	@When("Fill in all the fields {string},{string},{string},{string}except description with valid values in batch")
	...
	@When("Fill in all the fields with valid values {string},{string},{string},{string},{string} and click save in batch")
	...
	@When("When any of the fields have invalid values {string} and {string},{string},{string},{string} as valid  in batch"
			)
	...
	@Then("Error message {string} should appear in batch")
	...
	@When("When Any of the mandatory fields {string} are blank and valid  {string}, {string}, {string}, {string} in batch")
...
//EDITBATCH
	...
	@When("Update the fields with valid values {string},{string},{string},{string},{string}and click save in batch")
	...
	@Then("The updated batch details {string}{string} should appear on the data table in batch")
	...
	@When("Update the fields with invalid values {string},{string},{string},{string},{string} and click save in batch")
	...
	@When("Erase data from mandatory field {string},{string},{string},{string},{string}in batch")
	...
	@When("Erase data from description field and enters valid {string},{string},{string},{string} in batch")
...
//MULTIPLEDELETEBATCH
	...
	@Then("The delete icon under manage batch header should be disabled in batch")
